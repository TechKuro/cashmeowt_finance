...
const InputList = ({ onAdd, totalExpenses, setTotalExpenses }) => {
  ...
  return (<div id='expenses' className='max-w-[1140px] md:flex m-auto w-full p-10 bg-gradient-to-r from-yellow-300  to-lime-600 rounded shadow-lg'>
  ...
  <div className='flex flex-col my-2 py-2'>
    ...
    <div className="relative mt-2 rounded-md shadow-sm">
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          <input className='block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="0.00'
            type="number"
            value={inputValue}
          ...
          />
          <button className='ml-3 text-center'onClick={handleSave}>Save</button> 
        </div>
      </div>     
    </div>
    </div>
